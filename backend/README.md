...
## Project Structure
    ...
    ├── testapiautocatalog_103769  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103769`
...
2. Clone this repo and `cd testapiautocatalog_103769`
